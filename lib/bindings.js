...
var LLVMPassRegistryRef = exports.LLVMPassRegistryRef = voidPtr;
var LLVMPassRegistryRefPtr = exports.LLVMPassRegistryRefPtr = ref.refType(LLVMPassRegistryRef);
var LLVMFatalErrorHandler = exports.LLVMFatalErrorHandler = FFI.Function(ref.types.void, [
  ref.types.CString,
]);
var LLVMFatalErrorHandlerPtr = exports.LLVMFatalErrorHandlerPtr = ref.refType(LLVMFatalErrorHandler);
var LLVMContextRef = exports.LLVMContextRef = voidPtr;
var LLVMContextRefPtr = exports.LLVMContextRefPtr = ref.refType(LLVMContextRef);
var LLVMDiagnosticHandler = exports.LLVMDiagnosticHandler = FFI.Function(ref.types.void, [
  voidPtr,
  voidPtr,
]);
var LLVMDiagnosticHandlerPtr = exports.LLVMDiagnosticHandlerPtr = ref.refType(LLVMDiagnosticHandler);
var LLVMYieldCallback = exports.LLVMYieldCallback = FFI.Function(ref.types.void, [
  voidPtr,
  voidPtr,
]);
var LLVMYieldCallbackPtr = exports.LLVMYieldCallbackPtr = ref.refType(LLVMYieldCallback);
var LLVMDiagnosticInfoRef = exports.LLVMDiagnosticInfoRef = voidPtr;
var LLVMDiagnosticInfoRefPtr = exports.LLVMDiagnosticInfoRefPtr = ref.refType(LLVMDiagnosticInfoRef);
var LLVMModuleRef = exports.LLVMModuleRef = voidPtr;
var LLVMModuleRefPtr = exports.LLVMModuleRefPtr = ref.refType(LLVMModuleRef);
var LLVMTypeRef = exports.LLVMTypeRef = voidPtr;
var LLVMTypeRefPtr = exports.LLVMTypeRefPtr = ref.refType(LLVMTypeRef);
var LLVMValueRef = exports.LLVMValueRef = voidPtr;
var LLVMValueRefPtr = exports.LLVMValueRefPtr = ref.refType(LLVMValueRef);
var LLVMUseRef = exports.LLVMUseRef = voidPtr;
var LLVMUseRefPtr = exports.LLVMUseRefPtr = ref.refType(LLVMUseRef);
var LLVMBasicBlockRef = exports.LLVMBasicBlockRef = voidPtr;
var LLVMBasicBlockRefPtr = exports.LLVMBasicBlockRefPtr = ref.refType(LLVMBasicBlockRef);
var LLVMBuilderRef = exports.LLVMBuilderRef = voidPtr;
var LLVMBuilderRefPtr = exports.LLVMBuilderRefPtr = ref.refType(LLVMBuilderRef);
var LLVMModuleProviderRef = exports.LLVMModuleProviderRef = voidPtr;
var LLVMModuleProviderRefPtr = exports.LLVMModuleProviderRefPtr = ref.refType(LLVMModuleProviderRef);
var LLVMMemoryBufferRef = exports.LLVMMemoryBufferRef = voidPtr;
var LLVMMemoryBufferRefPtr = exports.LLVMMemoryBufferRefPtr = ref.refType(LLVMMemoryBufferRef);
var LLVMPassManagerRef = exports.LLVMPassManagerRef = voidPtr;
var LLVMPassManagerRefPtr = exports.LLVMPassManagerRefPtr = ref.refType(LLVMPassManagerRef);

exports.library = new FFI.Library('libLLVM-3.6', {
  LLVMLoadLibraryPermanently: [ref.types.int32, [
    ref.types.CString,
  ]],
  LLVMInitializeCore: [ref.types.void, [
    LLVMPassRegistryRef,
  ]],
  LLVMShutdown: [ref.types.void, [
  ]],
  LLVMCreateMessage: [ref.types.CString, [
    ref.types.CString,
  ]],
  LLVMDisposeMessage: [ref.types.void, [
    ref.types.CString,
  ]],
  LLVMInstallFatalErrorHandler: [ref.types.void, [
  ...
  LLVMContextSetDiagnosticHandler: [ref.types.void, [
    LLVMContextRef,
    LLVMDiagnosticHandler,
    voidPtr,
  ]],
  LLVMContextSetYieldCallback: [ref.types.void, [
    LLVMContextRef,
    LLVMYieldCallback,
    voidPtr,
  ]],
  LLVMContextDispose: [ref.types.void, [
    LLVMContextRef,
  ]],
  LLVMGetDiagInfoDescription: [ref.types.CString, [
    LLVMDiagnosticInfoRef,
  ]],
  LLVMGetDiagInfoSeverity: [ref.types.uint32, [
    LLVMDiagnosticInfoRef,
  ]],
  LLVMGetMDKindIDInContext: [ref.types.uint32, [
    LLVMContextRef,
    ref.types.CString,
    ref.types.uint32,
  ]],
  LLVMGetMDKindID: [ref.types.uint32, [
    ref.types.CString,
    ref.types.uint32,
  ]],
  ...
  LLVMDisposeModule: [ref.types.void, [
    LLVMModuleRef,
  ]],
  LLVMGetDataLayout: [ref.types.CString, [
    LLVMModuleRef,
  ]],
  LLVMSetDataLayout: [ref.types.void, [
    LLVMModuleRef,
    ref.types.CString,
  ]],
  LLVMGetTarget: [ref.types.CString, [
    LLVMModuleRef,
  ]],
  LLVMSetTarget: [ref.types.void, [
    LLVMModuleRef,
    ref.types.CString,
  ]],
  LLVMDumpModule: [ref.types.void, [
    LLVMModuleRef,
  ]],
  LLVMPrintModuleToFile: [ref.types.int32, [
    LLVMModuleRef,
    ref.types.CString,
    voidPtr,
  ]],
  LLVMPrintModuleToString: [ref.types.CString, [
    LLVMModuleRef,
  ]],
  LLVMSetModuleInlineAsm: [ref.types.void, [
    LLVMModuleRef,
    ref.types.CString,
  ]],
  ...
  LLVMGetNamedMetadataNumOperands: [ref.types.uint32, [
    LLVMModuleRef,
    ref.types.CString,
  ]],
  LLVMGetNamedMetadataOperands: [ref.types.void, [
    LLVMModuleRef,
    ref.types.CString,
    LLVMValueRef,
  ]],
  LLVMAddNamedMetadataOperand: [ref.types.void, [
    LLVMModuleRef,
    ref.types.CString,
    LLVMValueRef,
  ]],
  ...
  LLVMGetTypeKind: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  LLVMTypeIsSized: [ref.types.int32, [
    LLVMTypeRef,
  ]],
  LLVMGetTypeContext: [LLVMContextRef, [
    LLVMTypeRef,
  ]],
  LLVMDumpType: [ref.types.void, [
    LLVMTypeRef,
  ]],
  LLVMPrintTypeToString: [ref.types.CString, [
    LLVMTypeRef,
  ]],
  ...
  LLVMGetIntTypeWidth: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  ...
  LLVMIsFunctionVarArg: [ref.types.int32, [
    LLVMTypeRef,
  ]],
  LLVMGetReturnType: [LLVMTypeRef, [
    LLVMTypeRef,
  ]],
  LLVMCountParamTypes: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  LLVMGetParamTypes: [ref.types.void, [
    LLVMTypeRef,
    LLVMTypeRefPtr,
  ]],
  ...
  LLVMGetStructName: [ref.types.CString, [
    LLVMTypeRef,
  ]],
  LLVMStructSetBody: [ref.types.void, [
    LLVMTypeRef,
    LLVMTypeRefPtr,
    ref.types.uint32,
    ref.types.int32,
  ]],
  LLVMCountStructElementTypes: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  LLVMGetStructElementTypes: [ref.types.void, [
    LLVMTypeRef,
    LLVMTypeRefPtr,
  ]],
  LLVMIsPackedStruct: [ref.types.int32, [
    LLVMTypeRef,
  ]],
  LLVMIsOpaqueStruct: [ref.types.int32, [
    LLVMTypeRef,
  ]],
  ...
  LLVMGetArrayLength: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  ...
  LLVMGetPointerAddressSpace: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  ...
  LLVMGetVectorSize: [ref.types.uint32, [
    LLVMTypeRef,
  ]],
  ...
  LLVMGetValueName: [ref.types.CString, [
    LLVMValueRef,
  ]],
  LLVMSetValueName: [ref.types.void, [
    LLVMValueRef,
    ref.types.CString,
  ]],
  LLVMDumpValue: [ref.types.void, [
    LLVMValueRef,
  ]],
  LLVMPrintValueToString: [ref.types.CString, [
    LLVMValueRef,
  ]],
  LLVMReplaceAllUsesWith: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRef,
  ]],
  LLVMIsConstant: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMIsUndef: [ref.types.int32, [
    LLVMValueRef,
  ]],
  ...
  LLVMSetOperand: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
    LLVMValueRef,
  ]],
  LLVMGetNumOperands: [ref.types.int32, [
    LLVMValueRef,
  ]],
  ...
  LLVMConstIntGetZExtValue: [ref.types.ulonglong, [
    LLVMValueRef,
  ]],
  LLVMConstIntGetSExtValue: [ref.types.longlong, [
    LLVMValueRef,
  ]],
  ...
  LLVMGetConstOpcode: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  ...
  LLVMIsDeclaration: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMGetLinkage: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetLinkage: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMGetSection: [ref.types.CString, [
    LLVMValueRef,
  ]],
  LLVMSetSection: [ref.types.void, [
    LLVMValueRef,
    ref.types.CString,
  ]],
  LLVMGetVisibility: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetVisibility: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMGetDLLStorageClass: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetDLLStorageClass: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMHasUnnamedAddr: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetUnnamedAddr: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMGetAlignment: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetAlignment: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  ...
  LLVMDeleteGlobal: [ref.types.void, [
    LLVMValueRef,
  ]],
  LLVMGetInitializer: [LLVMValueRef, [
    LLVMValueRef,
  ]],
  LLVMSetInitializer: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRef,
  ]],
  LLVMIsThreadLocal: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetThreadLocal: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMIsGlobalConstant: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetGlobalConstant: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMGetThreadLocalMode: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetThreadLocalMode: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMIsExternallyInitialized: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetExternallyInitialized: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  ...
  LLVMDeleteFunction: [ref.types.void, [
    LLVMValueRef,
  ]],
  LLVMGetIntrinsicID: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMGetFunctionCallConv: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetFunctionCallConv: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMGetGC: [ref.types.CString, [
    LLVMValueRef,
  ]],
  LLVMSetGC: [ref.types.void, [
    LLVMValueRef,
    ref.types.CString,
  ]],
  LLVMAddFunctionAttr: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMAddTargetDependentFunctionAttr: [ref.types.void, [
    LLVMValueRef,
    ref.types.CString,
    ref.types.CString,
  ]],
  LLVMGetFunctionAttr: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMRemoveFunctionAttr: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMCountParams: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMGetParams: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRefPtr,
  ]],
  ...
  LLVMAddAttribute: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMRemoveAttribute: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  LLVMGetAttribute: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetParamAlignment: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  ...
  LLVMGetMDString: [ref.types.CString, [
    LLVMValueRef,
    ref.refType(ref.types.uint32),
  ]],
  LLVMGetMDNodeNumOperands: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMGetMDNodeOperands: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRefPtr,
  ]],
  ...
  LLVMValueIsBasicBlock: [ref.types.int32, [
    LLVMValueRef,
  ]],
  ...
  LLVMCountBasicBlocks: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMGetBasicBlocks: [ref.types.void, [
    LLVMValueRef,
  ...
  LLVMDeleteBasicBlock: [ref.types.void, [
    LLVMBasicBlockRef,
  ]],
  LLVMRemoveBasicBlockFromParent: [ref.types.void, [
    LLVMBasicBlockRef,
  ]],
  LLVMMoveBasicBlockBefore: [ref.types.void, [
    LLVMBasicBlockRef,
    LLVMBasicBlockRef,
  ]],
  LLVMMoveBasicBlockAfter: [ref.types.void, [
    LLVMBasicBlockRef,
    LLVMBasicBlockRef,
  ]],
  ...
  LLVMHasMetadata: [ref.types.int32, [
    LLVMValueRef,
  ]],
  ...
  LLVMSetMetadata: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
    LLVMValueRef,
  ]],
  ...
  LLVMInstructionEraseFromParent: [ref.types.void, [
    LLVMValueRef,
  ]],
  LLVMGetInstructionOpcode: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMGetICmpPredicate: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMSetInstructionCallConv: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
  ]],
  LLVMGetInstructionCallConv: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  LLVMAddInstrAttribute: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
    ref.types.int32,
  ]],
  LLVMRemoveInstrAttribute: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
    ref.types.int32,
  ]],
  LLVMSetInstrParamAlignment: [ref.types.void, [
    LLVMValueRef,
    ref.types.uint32,
    ref.types.uint32,
  ]],
  LLVMIsTailCall: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetTailCall: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  ...
  LLVMAddIncoming: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRefPtr,
    LLVMBasicBlockRefPtr,
    ref.types.uint32,
  ]],
  LLVMCountIncoming: [ref.types.uint32, [
    LLVMValueRef,
  ]],
  ...
  LLVMPositionBuilder: [ref.types.void, [
    LLVMBuilderRef,
    LLVMBasicBlockRef,
    LLVMValueRef,
  ]],
  LLVMPositionBuilderBefore: [ref.types.void, [
    LLVMBuilderRef,
    LLVMValueRef,
  ]],
  LLVMPositionBuilderAtEnd: [ref.types.void, [
    LLVMBuilderRef,
    LLVMBasicBlockRef,
  ]],
  ...
  LLVMClearInsertionPosition: [ref.types.void, [
    LLVMBuilderRef,
  ]],
  LLVMInsertIntoBuilder: [ref.types.void, [
    LLVMBuilderRef,
    LLVMValueRef,
  ]],
  LLVMInsertIntoBuilderWithName: [ref.types.void, [
    LLVMBuilderRef,
    LLVMValueRef,
    ref.types.CString,
  ]],
  LLVMDisposeBuilder: [ref.types.void, [
    LLVMBuilderRef,
  ]],
  LLVMSetCurrentDebugLocation: [ref.types.void, [
    LLVMBuilderRef,
    LLVMValueRef,
  ]],
  ...
  LLVMSetInstDebugLocation: [ref.types.void, [
    LLVMBuilderRef,
    LLVMValueRef,
  ]],
  ...
  LLVMAddCase: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRef,
    LLVMBasicBlockRef,
  ]],
  LLVMAddDestination: [ref.types.void, [
    LLVMValueRef,
    LLVMBasicBlockRef,
  ]],
  LLVMAddClause: [ref.types.void, [
    LLVMValueRef,
    LLVMValueRef,
  ]],
  LLVMSetCleanup: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  ...
  LLVMGetVolatile: [ref.types.int32, [
    LLVMValueRef,
  ]],
  LLVMSetVolatile: [ref.types.void, [
    LLVMValueRef,
    ref.types.int32,
  ]],
  ...
  LLVMDisposeModuleProvider: [ref.types.void, [
    LLVMModuleProviderRef,
  ]],
  LLVMCreateMemoryBufferWithContentsOfFile: [ref.types.int32, [
    ref.types.CString,
    LLVMMemoryBufferRef,
    voidPtr,
  ]],
  LLVMCreateMemoryBufferWithSTDIN: [ref.types.int32, [
  ...
  LLVMGetBufferStart: [ref.types.CString, [
    LLVMMemoryBufferRef,
  ]],
  LLVMGetBufferSize: [ref.types.int32, [
    LLVMMemoryBufferRef,
  ]],
  LLVMDisposeMemoryBuffer: [ref.types.void, [
    LLVMMemoryBufferRef,
  ]],
  ...
  LLVMRunPassManager: [ref.types.int32, [
    LLVMPassManagerRef,
    LLVMModuleRef,
  ]],
  LLVMInitializeFunctionPassManager: [ref.types.int32, [
    LLVMPassManagerRef,
  ]],
  LLVMRunFunctionPassManager: [ref.types.int32, [
    LLVMPassManagerRef,
    LLVMValueRef,
  ]],
  LLVMFinalizeFunctionPassManager: [ref.types.int32, [
    LLVMPassManagerRef,
  ]],
  LLVMDisposePassManager: [ref.types.void, [
    LLVMPassManagerRef,
  ]],
