...
rt = require('./LLVMRefTypes')

voidPtr = rt.voidPtr
LLVMPassRegistryRef      = rt.LLVMPassRegistryRef
LLVMPassRegistryRefPtr   = rt.LLVMPassRegistryRefPtr
LLVMFatalErrorHandler    = rt.LLVMFatalErrorHandler
LLVMFatalErrorHandlerPtr = rt.LLVMFatalErrorHandlerPtr
LLVMContextRef           = rt.LLVMContextRef
LLVMContextRefPtr        = rt.LLVMContextRefPtr
LLVMDiagnosticInfoRef    = rt.LLVMDiagnosticInfoRef
LLVMDiagnosticInfoRefPtr = rt.LLVMDiagnosticInfoRefPtr
LLVMModuleRef            = rt.LLVMModuleRef
LLVMModuleRefPtr         = rt.LLVMModuleRefPtr
LLVMTypeRef              = rt.LLVMTypeRef
LLVMTypeRefPtr           = rt.LLVMTypeRefPtr
LLVMValueRef             = rt.LLVMValueRef
LLVMValueRefPtr          = rt.LLVMValueRefPtr
LLVMUseRef               = rt.LLVMUseRef
LLVMUseRefPtr            = rt.LLVMUseRefPtr
LLVMBasicBlockRef        = rt.LLVMBasicBlockRef
LLVMBasicBlockRefPtr     = rt.LLVMBasicBlockRefPtr
LLVMBuilderRef           = rt.LLVMBuilderRef
LLVMBuilderRefPtr        = rt.LLVMBuilderRefPtr
LLVMModuleProviderRef    = rt.LLVMModuleProviderRef
LLVMModuleProviderRefPtr = rt.LLVMModuleProviderRefPtr
LLVMMemoryBufferRef      = rt.LLVMMemoryBufferRef
LLVMMemoryBufferRefPtr   = rt.LLVMMemoryBufferRefPtr
LLVMPassManagerRef       = rt.LLVMPassManagerRef
LLVMPassManagerRefPtr    = rt.LLVMPassManagerRefPtr
